...
const IMPORT_LABEL_ALIASES: Record<string, Category> = {
  ...
  // UAE / India UPI & bank export labels
  upi: "Other",
  "upi payment": "Other",
  neft: "Other",
  imps: "Other",
  ...
  "water charges": "Bills & Utilities",
  "municipality charges": "Bills & Utilities",
  "e-commerce": "Shopping",
...
const MERCHANT_CATEGORY_MAP: Record<string, Category> = {
  ...
  "abu dhabi coop": "Groceries",
  "al ain coop": "Groceries",
  "emirates coop": "Groceries",
  "west zone": "Groceries",
  geant: "Groceries",
  "viva supermarket": "Groceries",
  "safari hypermarket": "Groceries",
  nesto: "Groceries",
  "al maya": "Groceries",
  "al adil": "Groceries",
  ...
  grandiose: "Groceries",
  waitrose: "Groceries",
  "park n shop": "Groceries",
  "zoom supermarket": "Groceries",

  // ── UAE: Food & Dining ──────────────────────────────────────
  shawarma: "Food & Dining",
  manousheh: "Food & Dining",
  "just falafel": "Food & Dining",
  "al baik": "Food & Dining",
  hardees: "Food & Dining",
  arbys: "Food & Dining",
  "pizza express": "Food & Dining",
  "more cafe": "Food & Dining",
  "paul bakery": "Food & Dining",
  "paul cafe": "Food & Dining",
  "zaatar w zeit": "Food & Dining",
  "operation falafel": "Food & Dining",
  "kcal": "Food & Dining",
  "ravi restaurant": "Food & Dining",
  "special ostadi": "Food & Dining",
  nandos: "Food & Dining",
  wagamama: "Food & Dining",
  "the cheesecake factory": "Food & Dining",
  "p.f. chang": "Food & Dining",
  "aquarium restaurant": "Food & Dining",
  talabat: "Food & Dining",
  ...
  // ── UAE: Transportation ─────────────────────────────────────
  "rta ": "Transportation",
  "nol card": "Transportation",
  "dubai metro": "Transportation",
  "abu dhabi bus": "Transportation",
  "s'hail": "Transportation",
  "dubai tram": "Transportation",
  ...
  sewa: "Bills & Utilities",
  addc: "Bills & Utilities",
  aadc: "Bills & Utilities",
  fewa: "Bills & Utilities",
  "du telecom": "Bills & Utilities",
  "du ": "Bills & Utilities",
  etisalat: "Bills & Utilities",
  "e& ": "Bills & Utilities",
  "virgin mobile uae": "Bills & Utilities",

  // ── UAE: Shopping ───────────────────────────────────────────
  noon: "Shopping",
  namshi: "Shopping",
  ounass: "Shopping",
  "level shoes": "Shopping",
  "brands for less": "Shopping",
  "max fashion": "Shopping",
  "home centre": "Shopping",
  "pan emirates": "Shopping",
  "ace hardware": "Shopping",
  "plug ins": "Shopping",
  "sharaf dg": "Shopping",
  jashanmal: "Shopping",
  "lulu fashion": "Shopping",
  centrepoint: "Shopping",
  babyshop: "Shopping",
  splash: "Shopping",
  matalan: "Shopping",
  "2xl furniture": "Shopping",

  // ── UAE: Entertainment ──────────────────────────────────────
  "reel cinemas": "Entertainment",
  "vox cinemas": "Entertainment",
  "novo cinemas": "Entertainment",
  cinemacity: "Entertainment",
  playnation: "Entertainment",
  "huawei music": "Entertainment",
  anghami: "Entertainment",
  starzplay: "Entertainment",
  shahid: "Entertainment",

  // ── UAE: Healthcare ─────────────────────────────────────────
  "aster pharmacy": "Healthcare",
  "aster clinic": "Healthcare",
  "life pharmacy": "Healthcare",
  medcare: "Healthcare",
  "dubai london clinic": "Healthcare",
  "american hospital": "Healthcare",
  mediclinic: "Healthcare",
  "cleveland clinic": "Healthcare",
  "prime medical": "Healthcare",
  "nmc health": "Healthcare",
  "ibn sina": "Healthcare",
  "aster dm": "Healthcare",
  ...
  "makemytrip bus": "Transportation",
  yulu: "Transportation",
  bounce: "Transportation",
  vahan: "Transportation",
  ...
  // ── INDIA: Bills & Utilities ─────────────────────────────────
  jio: "Bills & Utilities",
  airtel: "Bills & Utilities",
  "vi ": "Bills & Utilities",
  "vodafone in": "Bills & Utilities",
...
const TEXT_KEYWORD_WEIGHTS: Array<{ category: Category; term: string; weight: number }> = [
  ...
  // UAE OCR keywords
  { category: "Transportation", term: "salik", weight: 4 },
  { category: "Transportation", term: "nol", weight: 3 },
  { category: "Bills & Utilities", term: "dewa", weight: 5 },
  { category: "Bills & Utilities", term: "sewa", weight: 5 },
  { category: "Bills & Utilities", term: "fewa", weight: 5 },
  { category: "Bills & Utilities", term: "etisalat", weight: 4 },
  { category: "Food & Dining", term: "talabat", weight: 4 },
  { category: "Food & Dining", term: "deliveroo", weight: 3 },

  // India OCR keywords
  { category: "Transportation", term: "fastag", weight: 4 },
  { category: "Transportation", term: "irctc", weight: 4 },
  { category: "Transportation", term: "pnr", weight: 3 },
  { category: "Transportation", term: "boarding", weight: 2 },
  { category: "Groceries", term: "blinkit", weight: 4 },
  { category: "Groceries", term: "zepto", weight: 4 },
  { category: "Groceries", term: "instamart", weight: 4 },
  { category: "Food & Dining", term: "swiggy", weight: 4 },
  { category: "Food & Dining", term: "zomato", weight: 4 },
  { category: "Bills & Utilities", term: "recharge", weight: 3 },
  { category: "Bills & Utilities", term: "jio", weight: 3 },
  { category: "Bills & Utilities", term: "airtel", weight: 3 },
  { category: "Entertainment", term: "hotstar", weight: 3 },
  { category: "Entertainment", term: "bookmyshow", weight: 3 },
  { category: "Healthcare", term: "1mg", weight: 3 },
  { category: "Healthcare", term: "pharmeasy", weight: 3 },
];
