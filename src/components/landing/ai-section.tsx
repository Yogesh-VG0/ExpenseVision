        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="animate-slide-right">
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Get deep spending analysis, actionable savings tips, and
              personalized financial advice — all generated by AI that
              understands your unique spending patterns.
            </p>
            ...
            <div className="mt-8 space-y-4">
              {[
                ...
                },
                {
                  ...
                  description:
                    "Find subscriptions to cancel and cheaper alternatives",
                },
                {
                  icon: Zap,
